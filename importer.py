import os
import psycopg2
from siemens_master import get_points


CONN = psycopg2.connect(host=os.environ.get('DATABASE_HOST') or '',
                        dbname=os.environ.get('DATABASE_NAME') or 'energy',
                        user=os.environ.get('DATABASE_USER') or 'energy',
                        password=os.environ.get('DATABASE_PASSWORD') or 'less!29carbon')
